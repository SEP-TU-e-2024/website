    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_type', models.CharField(default='Standard_B1s', help_text='All posible machine types can be found here, copy them EXACTLY AS WRITTEN: https://learn.microsoft.com/en-us/python/api/azure-mgmt-compute/azure.mgmt.compute.v2024_03_01.models.hardwareprofile?view=azure-python#keyword-only-parameters', max_length=256)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('example_submission_url', models.CharField(blank=True, max_length=512, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation_settings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.evaluationsettings')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('benchmark_instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.benchmarkinstance')),
